...
ngram-count -text ../../corpora/version4SF/AN_.txt -order 1 -lm ../lms/elder1gram_AN.gz -interpolate -kndiscount1 -kndiscount2 -kndiscount3 -debug 1 -gt2min 1 -gt3min 1 -gt4min 1 -vocab /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/58k.chinese.ori.wlist >& ../lms/elder1gram_AN.LOG
ngram-count -text ../../corpora/version4SF/PN_.txt -order 1 -lm ../lms/elder1gram_PN.gz -interpolate -kndiscount1 -kndiscount2 -kndiscount3 -debug 1 -gt2min 1 -gt3min 1 -gt4min 1 -vocab /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/58k.chinese.ori.wlist >& ../lms/elder1gram_PN.LOG
