...
WLIST="/mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist"


# 一元

ngram-count -text ../../corpora/version4SF/AN3_.txt -order 1 -lm ../lms/elder1gram_AN.gz -interpolate -debug 1 -gt2min 1 -gt3min 1 -gt4min 1 -vocab /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist >& ../lms/elder1gram_AN.LOG
ngram-count -text ../../corpora/version4SF/PN3_.txt -order 1 -lm ../lms/elder1gram_PN.gz -interpolate -debug 1 -gt2min 1 -gt3min 1 -gt4min 1 -vocab /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist >& ../lms/elder1gram_PN.LOG
ngram-count -text ../../corpora/version4SF/train_L_SF_v3_.txt -order 1 -lm ../lms/elder1gram_L_SF.gz -interpolate -debug 1 -gt2min 1 -gt3min 1 -gt4min 1 -vocab /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist >& ../lms/elder1gram_L_SF.LOG
ngram-count -text ../../corpora/version4SF/FN_.txt -order 1 -lm ../lms/elder1gram_FN.gz -interpolate -debug 1 -gt2min 1 -gt3min 1 -gt4min 1 -vocab /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist >& ../lms/elder1gram_FN.LOG
...
../streams/PN_1gram.st   0.1030574507
../streams/AN_1gram.st   0.0424552036
../streams/FN_1gram.st   0.0096047848
../streams/SF_1gram.st   0.8448825609

# 3. 根据生成新模型
# Tips:语言模型后面不需要加‘.gz'
LMerge -A -D -V -C ../../scripts/config.lnorm -T 1 -f text -i 0.0424552036 ../lms/elder1gram_AN -i 0.0096047848 ../lms/elder1gram_FN -i 0.8448825609 ../lms/elder1gram_L_SF /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist ../lms/elder1gram_PN  ../lms/elder1gram_Merge >& ../lms/elder1gram_Merge.LOG
...
# /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist ../lms/elder3gram_SI  ../lms/elder3gram_Merge >& ../lms/elder3gram_Merge.LOG
#

#LMerge -A -D -V -C ../../scripts/config.lnorm -T 1 -f text -i 0.0783987817 ../lms/elder3gram_PD -i 0.0364961674 ../lms/elder3gram_KY -i 0.0976168964 ../lms/elder3gram_JB -i 0.0085570213 ../lms/elder3gram_HJ -i 0.5378398445 ../lms/elder3gram_L_hasSR -i 0.0184633325 /mnt/shareEx/srf/LM-Train/TDT4/lms/tdt4-3gram -i 0.1849658950 /mnt/shareEx/srf/LM-Train/Gigaword/lms/gigaword-3gram /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist ../lms/elder3gram_SI  ../lms/elder3gram_Merge_hasSR >& ../lms/elder3gram_Merge_hasSR.LOG
#LMerge -A -D -V -C ../../scripts/config.lnorm -T 1 -f text -i 0.1066724522 ../lms/elder3gram_PD -i 0.0511671312 ../lms/elder3gram_KY -i 0.1308649545 ../lms/elder3gram_JB -i 0.0123297550 ../lms/elder3gram_HJ -i 0.3718505288 ../lms/elder3gram_L_notSR -i 0.0192098333 /mnt/shareEx/srf/LM-Train/TDT4/lms/tdt4-3gram -i 0.2376853846 /mnt/shareEx/srf/LM-Train/Gigaword/lms/gigaword-3gram /mnt/shareEx/panjingshen/ElderVoice/LM/scripts/SF_v3.wlist ../lms/elder3gram_SI  ../lms/elder3gram_Merge_notSR >& ../lms/elder3gram_Merge_notSR.LOG
