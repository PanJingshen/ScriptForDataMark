...
ngram -debug 2 -lm ../lms/elder2gram_Merge_hasSR.gz -order 2 -ppl ../../corpora/version1/test_L_SR.txt > ../ppl/Merge_hasSR_SR.ppl
ngram -debug 2 -lm ../lms/elder2gram_Merge_hasSR.gz -order 2 -ppl ../../corpora/version1/test_L_SS.txt > ../ppl/Merge_hasSR_SS.ppl
ngram -debug 2 -lm ../lms/elder2gram_Merge_hasSR.gz -order 2 -ppl ../../corpora/version1/test_L_SI.txt > ../ppl/Merge_hasSR_SI.ppl
ngram -debug 2 -lm ../lms/elder2gram_Merge_hasSR.gz -order 2 -ppl ../../corpora/version1/test_L_PD.txt > ../ppl/Merge_hasSR_PD.ppl

ngram -debug 2 -lm ../lms/elder2gram_Merge_notSR.gz -order 2 -ppl ../../corpora/version1/test_L_SR.txt > ../ppl/Merge_notSR_SR.ppl
ngram -debug 2 -lm ../lms/elder2gram_Merge_notSR.gz -order 2 -ppl ../../corpora/version1/test_L_SS.txt > ../ppl/Merge_notSR_SS.ppl
ngram -debug 2 -lm ../lms/elder2gram_Merge_notSR.gz -order 2 -ppl ../../corpora/version1/test_L_SI.txt > ../ppl/Merge_notSR_SI.ppl
ngram -debug 2 -lm ../lms/elder2gram_Merge_notSR.gz -order 2 -ppl ../../corpora/version1/test_L_PD.txt > ../ppl/Merge_notSR_PD.ppl
